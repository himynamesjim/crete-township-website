...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/community-center/friends`,        lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${BASE}/community-center/friends/brick-fundraiser`, lastModified: now, changeFrequency: 'monthly', priority: 0.5 },
    // Services
